...
gig1 = Gig.create!({title: "I will sing hey there Delilah, customized to your name", creator_id: 1, price: 5, image_url: "https://www.filepicker.io/api/file/N3UbKSJJS9ygMwR9E3as", description: "I will sing hey there Delilah, customized to your name"})
gig1.extras.create!([
  {title: "I will create a snapchat account for you so you can get started", price: 5},
  {title: "I will tell them happy birthday inside a Maserati GranTurismo", price: 25},
  {title: "I will tell them happy birthday in Spanish", price: 5}
])
Gig.create!([
